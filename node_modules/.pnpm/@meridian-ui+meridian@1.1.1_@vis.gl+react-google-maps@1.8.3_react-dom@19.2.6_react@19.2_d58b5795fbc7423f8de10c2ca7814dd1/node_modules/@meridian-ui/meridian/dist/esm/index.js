...
var OverviewBasicList = function (options) {
    return (jsx("div", { className: "overview-basic", children: jsx("div", { className: "overview-basic-container ".concat(options.overview.className), children: options.items.map(function (item, index) { return (jsx(MeridianItem, { options: options, item: item, itemView: options.overview.itemView, index: index }, index)); }) }) }));
};
...
var MeridianOverview = function (_a) {
    ...
    return (jsxs("div", { children: [jsxs("div", { className: "flex flex-col", children: [malleableCompositionSetting().includes("tabs") && (jsx(MalleabilityOvervewTabs, {})), enabledMalleableContent() && !malleableCompositionSetting().includes("tabs") && jsx(MalleabilityAttributesToggle, {})] }), odi.overviews
    ...
    return (jsxs("div", { 
        ...
        className: "".concat(className), style: __assign({ cursor: detailToOpen && !highlightAttributes ? "pointer" : "auto" }, style), onClick: function (e) {
            ...
            if ((detailToOpen === null || detailToOpen === void 0 ? void 0 : detailToOpen.openIn) === "new-page") {
                ...
                (selectedItemEntity === null || selectedItemEntity === void 0 ? void 0 : selectedItemEntity.detail.openIn) === "tooltip" && (jsx("div", { className: "absolute w-[400px] h-fit max-h-[500px] bg-white shadow-2xl h-[96%] rounded-md z-10 overflow-scroll", style: {
                    left: "calc(50% - 200px)",
                    top: -520,
...
var OverviewBasicGrid = function (options) {
    return (jsx("div", { className: "overview-basic-grid", children: jsx("div", { className: "overview-basic-container", children: options.items.map(function (item, index) { return (jsx("div", { className: "overview-basic-item", children: jsx(MeridianItem, { options: options, item: item, itemView: options.overview.itemView, index: index }) }, index)); }) }) }));
};
...
var OverviewBasicMap = function (options) {
    ...
    return (jsx("div", { className: "w-full h-full flex flex-col items-center py-8 px-4", children: jsx("div", { className: "w-full h-[90vh]", children: jsx(APIProvider, { apiKey: googleMapsAPIKey !== null && googleMapsAPIKey !== void 0 ? googleMapsAPIKey : "", children: jsx(Map$1, { mapId: "311ade41f7abdcb7", style: {
                        width: "100%",
                        height: "100%",
                    }, 
                    // className="gm-style"
                    defaultCenter: defaultCenter, defaultZoom: defaultZoom, children: coordinates &&
                        options.items.map(function (item, index) {
                            ...
                            return (jsx(AdvancedMarker, { position: position, zIndex: hoveredItemId === (item === null || item === void 0 ? void 0 : item.itemId) ? 6 : 3, children: jsx("div", { className: "w-[fit-content] max-w-[500px] bg-white border border-gray-400 rounded-2xl shadow-md shadow-black/40\n                      transition ".concat(detailToOpen && !highlightAttributes
                                    ...
                                    }, onMouseOver: function () { var _a; return setHoveredItemId((_a = item === null || item === void 0 ? void 0 : item.itemId) !== null && _a !== void 0 ? _a : ""); }, children: jsx(MeridianItem, { item: item, options: options, index: index, itemView: options.overview.itemView }) }) }, "".concat(item === null || item === void 0 ? void 0 : item.itemId, "-").concat(index)));
                        }) }, "map" + mapOverview.id) }) }) }));
};
...
var OverviewBasicTable = function (options) {
    ...
    var detailToOpen = findItemDetailViewToOpen(options, odi);
    return (jsx("div", { className: "overview-basic overview-basic-table", children: jsx("div", { className: "table-container", children: jsxs("table", { children: [jsx("thead", { children: jsx("tr", { children: headerInfo.map(function (header, index) { return (jsx("th", { children: header.headerText }, index)); }) }) }), jsx("tbody", { children: options.items.map(function (item, index) { return (jsx("tr", { style: {
