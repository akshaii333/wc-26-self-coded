...
var OverviewBasicList = function (options) {
    return (jsxRuntime.jsx("div", { className: "overview-basic", children: jsxRuntime.jsx("div", { className: "overview-basic-container ".concat(options.overview.className), children: options.items.map(function (item, index) { return (jsxRuntime.jsx(MeridianItem, { options: options, item: item, itemView: options.overview.itemView, index: index }, index)); }) }) }));
};
...
var Attribute = function (_a) {
    ...
    var AttributeItem = function (_a) {
        ...
        if (attribute.type && attributeTypesMap[attribute.type]) {
            ...
            return (jsxRuntime.jsx(AttributeComponent, { attribute: attribute, options: options, item: options.items[(_b = attribute.itemIndex) !== null && _b !== void 0 ? _b : 0] }));
        }
        // If the attribute is an overview, return the overview component
        if (attribute.type === "overview") {
            console.log("overview", attribute);
            return (jsxRuntime.jsx(MeridianOverview, { overviewIdToShow: attribute.id, attribute: attribute }));
        }
        ...
        if (!isAttributeType(attribute)) {
            ...
            return (jsxRuntime.jsx("div", { className: "attribute ".concat(classNameString), style: __assign(__assign({}, styleObject), { overflow: "hidden", width: options.overview.type === "table" ? "200px" : "auto", padding: options.overview.type === "table" ? "6px" : "0px" }), children: jsxRuntime.jsx("img", { src: (_c = attribute.value) === null || _c === void 0 ? void 0 : _c.toString() }) }));
        }
        else if (attribute.type === "link") {
            return (jsxRuntime.jsx("a", { className: classNameString, style: styleObject, href: (_d = attribute.value) === null || _d === void 0 ? void 0 : _d.toString(), children: (_e = attribute.label) !== null && _e !== void 0 ? _e : (_f = attribute.value) === null || _f === void 0 ? void 0 : _f.toString() }));
        }
        else if (attribute.type === "button") {
            return (jsxRuntime.jsx("button", { className: classNameString, style: styleObject, onClick: onAction, children: (_g = attribute.value) === null || _g === void 0 ? void 0 : _g.toString() }));
        }
        else {
            return (jsxRuntime.jsx("div", { className: "".concat(classNameString), style: styleObject, children: (_h = attribute.value) === null || _h === void 0 ? void 0 : _h.toString() }));
        }
    };
    var RenderAttribute = function (_a) {
        ...
        return (jsxRuntime.jsx("div", { className: "attribute-render ".concat(attributeIsSelected(attribute) ? "attribute-selected" : "", " ").concat(toHighlight ? "highlight-attributes" : ""), style: {
                ...
                attribute.value !== null ? (jsxRuntime.jsxs("span", { className: "attribute-item ".concat(classNameString), style: __assign(__assign({}, styleObject), { fontWeight: "300" }), children: [attribute.label, ":\u00A0", jsxRuntime.jsx(AttributeItem, { attribute: attribute, children: children })] })) : (jsxRuntime.jsx(AttributeItem, { attribute: attribute, children: children })) }, "".concat(attribute.itemIndex, "-").concat(attribute.index, "-").concat(attribute.id, "-render")));
    };
    if (Array.isArray(attribute) && attribute.length > 0) {
        return attribute.map(function (attr, idx) {
            return (jsxRuntime.jsx(RenderAttribute, { attribute: attr, children: children }, "".concat(attr === null || attr === void 0 ? void 0 : attr.itemIndex, "-").concat(attr === null || attr === void 0 ? void 0 : attr.index, "-").concat(attr === null || attr === void 0 ? void 0 : attr.id, "-").concat(idx)));
        });
    }
    else {
        return (jsxRuntime.jsx(RenderAttribute, { attribute: attribute, children: children }));
    }
};
...
var DetailBasic = function (_a) {
    ...
    if (!selectedItemEntity || !item) {
        ...
        return (jsxRuntime.jsxs("div", { className: "detail-view", children: [jsxRuntime.jsx("div", { className: "row g-3", children: jsxRuntime.jsxs("div", { className: "main-area", children: [jsxRuntime.jsxs("div", { className: "thumbnail-area", children: [jsxRuntime.jsx(Attribute, { className: "thumbnail", options: selectedItemEntity.options, attribute: getAttributesByRole(item, "thumbnail") }), jsxRuntime.jsx(Attribute, { options: selectedItemEntity.options, attribute: getAttributesByRole(item, "caption") }), jsxRuntime.jsx(Attribute, { className: "badge", options: selectedItemEntity.options, attribute: getAttributesByRole(item, "badge") })] }), jsxRuntime.jsxs("div", { className: "content-area", children: [jsxRuntime.jsx("div", { className: "header-area", children: ["title", "subtitle", "description", "key-attribute"].map(function (role) {
                                            return getAttributesByRole(item, role) && (jsxRuntime.jsx(Attribute, { className: role === "title"
                                                    ? "title"
                                                    : role === "subtitle"
                                                        ? "subtitle"
                                                        : "", options: selectedItemEntity.options, attribute: getAttributesByRole(item, role) }, role));
                                        }) }), jsxRuntime.jsx("div", { className: "fl g-2 sm", children: jsxRuntime.jsx(Attribute, { options: selectedItemEntity.options, attribute: getAttributesByRole(item, "tag") }) }), jsxRuntime.jsxs("div", { className: "fl g-2 sm", children: [jsxRuntime.jsx(Attribute, { options: selectedItemEntity.options, attribute: getAttributesByRole(item, "action") }), jsxRuntime.jsx(Attribute, { options: selectedItemEntity.options, attribute: getAttributesByRole(item, "link") })] })] }), jsxRuntime.jsx(Attribute, { options: selectedItemEntity.options, attribute: getAttributesByRole(item, "spec") }), jsxRuntime.jsx(Attribute, { options: selectedItemEntity.options, attribute: getAttributesByRole(item, "footer") })] }) }), unlabeledAttributes.length > 0 && (jsxRuntime.jsx("div", { className: "fl g-2", children: unlabeledAttributes.map(function (attr, idx) { return (jsxRuntime.jsx(Attribute, { options: selectedItemEntity.options, attribute: attr }, idx)); }) }))] }, item.itemId));
    }
};
...
function mapAttributes(item, itemIndex, attributes, parentId) {
    ...
    attributes.forEach(function (attr, attrIndex) {
        ...
        var id = attr.type === "overview" ? (_a = attr.id) !== null && _a !== void 0 ? _a : "" : (parentId && parentId !== "undefined") ? "".concat(parentId, "-").concat(attrIndex) : "".concat(attrIndex);
...
var MalleabilityAttributesToggle = function () {
    ...
    if (odi) {
        return (jsxRuntime.jsx("div", { className: "malleability-content-toggle", children: !((_b = (_a = odi.malleability) === null || _a === void 0 ? void 0 : _a.content) === null || _b === void 0 ? void 0 : _b.disabled) &&
                ((_e = (_d = (_c = odi.malleability) === null || _c === void 0 ? void 0 : _c.content) === null || _d === void 0 ? void 0 : _d.types) === null || _e === void 0 ? void 0 : _e.includes("toggle")) && (jsxRuntime.jsx("div", { className: "attributes-toggle", children: jsxRuntime.jsx("button", { onClick: function () { return setHighlightAttributes(!highlightAttributes); }, children: highlightAttributes ? "Off" : "Customize Content" }) })) }));
    }
    else {
        return jsxRuntime.jsx(jsxRuntime.Fragment, {});
    }
...
var ItemProfile = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", { className: "item-view item-profile ".concat(className), style: style, children: [jsxRuntime.jsxs("div", { className: "thumbnail-area", children: [jsxRuntime.jsx(Attribute, { className: "thumbnail", options: options, attribute: getAttributesByRole(item, "thumbnail") }), jsxRuntime.jsx(Attribute, { options: options, attribute: getAttributesByRole(item, "caption") })] }), jsxRuntime.jsxs("div", { className: "content-area", children: [jsxRuntime.jsxs("div", { className: "header-area", children: [jsxRuntime.jsx("div", { className: "column", children: ["subtitle", "title"].map(function (role) {
                                    return getAttributesByRole(item, role) && (jsxRuntime.jsx("div", { className: "title-area", children: jsxRuntime.jsx(Attribute, { className: role === "title"
                                                ? "title"
                                                : role === "subtitle"
                                                    ? "subtitle"
                                                    : "", options: options, attribute: getAttributesByRole(item, role) }) }, role));
                                }) }), jsxRuntime.jsx("div", { className: "row", children: ["description", "key-attribute"].map(function (role) {
                                    return getAttributesByRole(item, role) && (jsxRuntime.jsx(Attribute, { className: "sm", options: options, attribute: getAttributesByRole(item, role) }, role));
                                }) }), unlabeledAttributes.length > 0 && (jsxRuntime.jsx("div", { className: "column gap-1 sm", children: unlabeledAttributes.map(function (attr, idx) { return (jsxRuntime.jsx(Attribute, { options: options, attribute: attr }, idx)); }) })), jsxRuntime.jsx("div", { className: "fl g-2 sm", children: jsxRuntime.jsx(Attribute, { options: options, attribute: getAttributesByRole(item, "tag") }) }), jsxRuntime.jsx(Attribute, { className: "action fl g-2 sm", options: options, attribute: getAttributesByRole(item, "action") }), jsxRuntime.jsx(Attribute, { className: "link fl g-2 sm", options: options, attribute: getAttributesByRole(item, "link") })] }), jsxRuntime.jsx("div", { className: "specs", children: jsxRuntime.jsx(Attribute, { className: "spec", options: options, attribute: getAttributesByRole(item, "spec"), showLabel: true }) }), jsxRuntime.jsx(Attribute, { options: options, attribute: getAttributesByRole(item, "footer") })] }), jsxRuntime.jsx(Attribute, { className: "abs-float badge", options: options, attribute: getAttributesByRole(item, "badge") })] }));
};
...
var MeridianOverview = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", { children: [jsxRuntime.jsxs("div", { className: "flex flex-col", children: [malleableCompositionSetting().includes("tabs") && (jsxRuntime.jsx(MalleabilityOvervewTabs, {})), enabledMalleableContent() && !malleableCompositionSetting().includes("tabs") && jsxRuntime.jsx(MalleabilityAttributesToggle, {})] }), odi.overviews
            ...
            // ---- SIDE BY SIDE VIEW ----
            (selectedItemEntity === null || selectedItemEntity === void 0 ? void 0 : selectedItemEntity.detail.openIn) === "side-by-side" && (jsxRuntime.jsx("div", { className: "", children: jsxRuntime.jsx(MeridianDetail, { dataLists: dataLists, odi: odi, itemId: selectedItemEntity === null || selectedItemEntity === void 0 ? void 0 : selectedItemEntity.itemId }) }))] }));
};
    ...
    return (jsxRuntime.jsxs("div", { 
        ...
        className: "".concat(className), style: __assign({ cursor: detailToOpen && !highlightAttributes ? "pointer" : "auto" }, style), onClick: function (e) {
            ...
            if ((detailToOpen === null || detailToOpen === void 0 ? void 0 : detailToOpen.openIn) === "new-page") {
                ...
                (selectedItemEntity === null || selectedItemEntity === void 0 ? void 0 : selectedItemEntity.detail.openIn) === "tooltip" && (jsxRuntime.jsx("div", { className: "absolute w-[400px] h-fit max-h-[500px] bg-white shadow-2xl h-[96%] rounded-md z-10 overflow-scroll", style: {
                    left: "calc(50% - 200px)",
                    top: -520,
                }, children: jsxRuntime.jsx(MeridianDetail, { odi: odi, itemId: item.itemId }) })), jsxRuntime.jsx(ItemComponent, { options: options, item: item, index: index, className: className + (detailToOpen ? " item-hover" : ""), style: style })] }));
};
...
var MeridianDetail = function (_a) {
    ...
    if (selectedItem && odi) {
        ...
        return (jsxRuntime.jsxs("div", { className: "", children: [(((_e = odi === null || odi === void 0 ? void 0 : odi.malleability) === null || _e === void 0 ? void 0 : _e.disabled) === false ||
                    ((_f = odi === null || odi === void 0 ? void 0 : odi.malleability) === null || _f === void 0 ? void 0 : _f.disabled) === undefined) && (jsxRuntime.jsx(MalleabilityAttributesToggle, {})), jsxRuntime.jsx(DetailComponent, { item: selectedItem })] }));
    }
    else {
        return jsxRuntime.jsx("div", {});
    }
...
var OverviewBasicGrid = function (options) {
    return (jsxRuntime.jsx("div", { className: "overview-basic-grid", children: jsxRuntime.jsx("div", { className: "overview-basic-container", children: options.items.map(function (item, index) { return (jsxRuntime.jsx("div", { className: "overview-basic-item", children: jsxRuntime.jsx(MeridianItem, { options: options, item: item, itemView: options.overview.itemView, index: index }) }, index)); }) }) }));
};
...
var getMapData = function (items) {
    ...
    var coordinates = items.map(function (item) {
        ...
        var latAttribute = (_a = item.internalAttributes) === null || _a === void 0 ? void 0 : _a.find(function (attr) { return attr && typeof attr === "object" && attr.id === "lat"; });
        var lngAttribute = (_b = item.internalAttributes) === null || _b === void 0 ? void 0 : _b.find(function (attr) { return attr && typeof attr === "object" && attr.id === "lng"; });
        ...
        if (!googleMapsAPIKey) {
            var apiKeyAttr = item.attributes.find(function (attr) { return attr && "value" in attr && attr.id === "googleMapsAPIKey"; });
            if (apiKeyAttr) {
...
var OverviewBasicMap = function (options) {
    ...
    var _c = useODI(), odi = _c.odi; _c.setSelectedItemEntity; var highlightAttributes = _c.highlightAttributes;
    var _d = getMapData((_a = odi === null || odi === void 0 ? void 0 : odi.dataBinding[0].items) !== null && _a !== void 0 ? _a : []), coordinates = _d.coordinates, googleMapsAPIKey = _d.googleMapsAPIKey;
    ...
    return (jsxRuntime.jsx("div", { className: "w-full h-full flex flex-col items-center py-8 px-4", children: jsxRuntime.jsx("div", { className: "w-full h-[90vh]", children: jsxRuntime.jsx(reactGoogleMaps.APIProvider, { apiKey: googleMapsAPIKey !== null && googleMapsAPIKey !== void 0 ? googleMapsAPIKey : "", children: jsxRuntime.jsx(reactGoogleMaps.Map, { mapId: "311ade41f7abdcb7", style: {
                        width: "100%",
                        height: "100%",
                    }, 
                    // className="gm-style"
                    defaultCenter: defaultCenter, defaultZoom: defaultZoom, children: coordinates &&
                        options.items.map(function (item, index) {
                            ...
                            return (jsxRuntime.jsx(reactGoogleMaps.AdvancedMarker, { position: position, zIndex: hoveredItemId === (item === null || item === void 0 ? void 0 : item.itemId) ? 6 : 3, children: jsxRuntime.jsx("div", { className: "w-[fit-content] max-w-[500px] bg-white border border-gray-400 rounded-2xl shadow-md shadow-black/40\n                      transition ".concat(detailToOpen && !highlightAttributes
                                    ...
                                    }, onMouseOver: function () { var _a; return setHoveredItemId((_a = item === null || item === void 0 ? void 0 : item.itemId) !== null && _a !== void 0 ? _a : ""); }, children: jsxRuntime.jsx(MeridianItem, { item: item, options: options, index: index, itemView: options.overview.itemView }) }) }, "".concat(item === null || item === void 0 ? void 0 : item.itemId, "-").concat(index)));
                        }) }, "map" + mapOverview.id) }) }) }));
};
var calculateMapBounds = function (positions) {
    ...
    var padding = 0.2; // Reduced from 0.5
...
var ItemPin = function (_a) {
    ...
    useODI();
    var unlabeledAttributes = (_b = getAttributesWithoutRoles(item)) !== null && _b !== void 0 ? _b : [];
    return (jsxRuntime.jsxs("div", { className: "item-view item-pin item-profile ".concat(className), style: style, children: [jsxRuntime.jsxs("div", { className: "", children: [jsxRuntime.jsx("div", { className: "p-1", children: ["key-attribute"].map(function (role) {
                            return getAttributesByRole(item, role) && (jsxRuntime.jsx(Attribute, { className: role === "title" ? "f-m lg" : "f-b md", options: options, attribute: getAttributesByRole(item, role) }, role));
                        }) }), jsxRuntime.jsx("div", { className: "col j-c i-c", children: ["title", "subtitle", "description"].map(function (role) {
                            return getAttributesByRole(item, role) && (jsxRuntime.jsx(Attribute, { className: "sm", options: options, attribute: getAttributesByRole(item, role) }, role));
                        }) }), jsxRuntime.jsxs("div", { className: "", children: [jsxRuntime.jsx(Attribute, { className: "", options: options, attribute: getAttributesByRole(item, "thumbnail") }), jsxRuntime.jsx(Attribute, { options: options, attribute: getAttributesByRole(item, "caption") })] }), unlabeledAttributes.length > 0 && (jsxRuntime.jsx("div", { className: "col g-1 sm", children: unlabeledAttributes.map(function (attr, idx) { return (jsxRuntime.jsx(Attribute, { options: options, attribute: attr }, idx)); }) })), jsxRuntime.jsx("div", { className: "", children: jsxRuntime.jsx(Attribute, { options: options, attribute: getAttributesByRole(item, "tag") }) }), jsxRuntime.jsxs("div", { className: "", children: [jsxRuntime.jsx(Attribute, { options: options, attribute: getAttributesByRole(item, "action") }), jsxRuntime.jsx(Attribute, { options: options, attribute: getAttributesByRole(item, "link") })] })] }), jsxRuntime.jsx(Attribute, { options: options, attribute: getAttributesByRole(item, "spec") }), jsxRuntime.jsx(Attribute, { options: options, attribute: getAttributesByRole(item, "footer") }), jsxRuntime.jsx(Attribute, { className: "abs-float badge", options: options, attribute: getAttributesByRole(item, "badge") })] }));
};
...
var OverviewBasicTable = function (options) {
    var _a = useODI(), odi = _a.odi, setSelectedItemEntity = _a.setSelectedItemEntity, highlightAttributes = _a.highlightAttributes;
    ...
    var headerInfo = (sampleItem === null || sampleItem === void 0 ? void 0 : sampleItem.attributes.filter(function (attr) { return attr !== null && attr !== undefined; }).map(function (attr) {
        var _a, _b;
        var role = (_b = (_a = attr === null || attr === void 0 ? void 0 : attr.roles) === null || _a === void 0 ? void 0 : _a.at(0)) !== null && _b !== void 0 ? _b : "Attribute";
    ...
    var detailToOpen = findItemDetailViewToOpen(options, odi);
    return (jsxRuntime.jsx("div", { className: "overview-basic overview-basic-table", children: jsxRuntime.jsx("div", { className: "table-container", children: jsxRuntime.jsxs("table", { children: [jsxRuntime.jsx("thead", { children: jsxRuntime.jsx("tr", { children: headerInfo.map(function (header, index) { return (jsxRuntime.jsx("th", { children: header.headerText }, index)); }) }) }), jsxRuntime.jsx("tbody", { children: options.items.map(function (item, index) { return (jsxRuntime.jsx("tr", { style: {
                                ...
                                if (isAttributeType(attribute)) {
                                    ...
                                    return visibleNestedAttrs.map(function (nestedAttr, j) { return (jsxRuntime.jsx("td", { children: jsxRuntime.jsx(Attribute, { className: "attribute\n                            ".concat(isAttributeType(nestedAttr) &&
...
var AttributePrice = function (_a) {
    ...
    if (isAttributeType(attribute)) {
        return jsxRuntime.jsxs("div", { children: ["$", attribute.value] });
    }
    return jsxRuntime.jsx(jsxRuntime.Fragment, {});
};
...
var ItemVertical = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", { className: "item-view item-vertical ".concat(className), style: style, children: [jsxRuntime.jsxs("div", { className: "thumbnail-area", children: [jsxRuntime.jsx(Attribute, { className: "thumbnail", options: options, attribute: getAttributesByRole(item, "thumbnail") }), jsxRuntime.jsx(Attribute, { options: options, className: "caption", attribute: getAttributesByRole(item, "caption") })] }), jsxRuntime.jsxs("div", { className: "content-area", children: [jsxRuntime.jsxs("div", { className: "header-area", children: [jsxRuntime.jsx("div", { className: "column", children: ["subtitle", "title"].map(function (role) {
                                    return getAttributesByRole(item, role) && (jsxRuntime.jsx("div", { className: "title-area", children: jsxRuntime.jsx(Attribute, { className: role === "title"
                                                ? "title"
                                                : role === "subtitle"
                                                    ? "subtitle"
                                                    : "", options: options, attribute: getAttributesByRole(item, role) }) }, role));
                                }) }), jsxRuntime.jsx("div", { className: "column", children: ["description", "key-attribute"].map(function (role) {
                                    return getAttributesByRole(item, role) && (jsxRuntime.jsx(Attribute, { className: role === "description" ? "description" : "key-attribute  ", options: options, attribute: getAttributesByRole(item, role) }, role));
                                }) }), jsxRuntime.jsx("div", { className: "fl g-2 sm", children: jsxRuntime.jsx(Attribute, { className: "tag", options: options, attribute: getAttributesByRole(item, "tag") }) }), jsxRuntime.jsx(Attribute, { className: "action fl g-2 sm", options: options, attribute: getAttributesByRole(item, "action") }), jsxRuntime.jsx(Attribute, { className: "link fl g-2", options: options, attribute: getAttributesByRole(item, "link") })] }), jsxRuntime.jsx("div", { className: "specs", children: jsxRuntime.jsx(Attribute, { className: "spec", options: options, attribute: getAttributesByRole(item, "spec"), showLabel: true }) }), jsxRuntime.jsx(Attribute, { className: "xs", options: options, attribute: getAttributesByRole(item, "footer") })] }), jsxRuntime.jsx(Attribute, { className: "abs-float badge", options: options, attribute: getAttributesByRole(item, "badge") })] }));
};
    ...
    return __assign(__assign({ 
        ...
        odi: undefined, originalOdi: undefined, data: [], setODI: function (odi) { return set(function (state) {
            ...
            if (fetchedODI) {
                ...
                var setActiveOverview = get().setActiveOverview;
                setActiveOverview((_f = (_e = fetchedODI === null || fetchedODI === void 0 ? void 0 : fetchedODI.overviews[0]) === null || _e === void 0 ? void 0 : _e.id) !== null && _f !== void 0 ? _f : "");
...
var SettingComponent = function (_a) {
    ...
    if (mode === "toggle") {
        return (jsxRuntime.jsxs("div", { className: "setting-container", children: [jsxRuntime.jsx("div", { className: "setting-title", children: title }), jsxRuntime.jsx("div", { className: "setting-toggle-value ".concat(values === toggleOptions.on ? "toggle-on" : "toggle-off"), onClick: function () {
                        return handleOptionClick(values === toggleOptions.on ? toggleOptions.off : toggleOptions.on);
                    }, children: values })] }));
    }
    return (jsxRuntime.jsxs("div", { className: "setting-container setting-dropdown", ref: dropdownRef, children: [jsxRuntime.jsxs("div", { className: "setting-title setting-dropdown-title", onClick: function () { return setIsOpen(!isOpen); }, children: [title, jsxRuntime.jsx("svg", { className: "dropdown-arrow ".concat(isOpen ? "rotate" : ""), fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M19 9l-7 7-7-7" }) }), jsxRuntime.jsx("button", { onClick: handleClear, className: "w-4 h-4 hover:bg-zinc-100 rounded-full flex text-xs items-center justify-center text-zinc-100 hover:text-zinc-600", children: "Clear" })] }), jsxRuntime.jsx("div", { className: "setting-values", children: mode === "single" ? (jsxRuntime.jsx("div", { className: "setting-value", children: values })) : ((Array.isArray(values) ? values : [values]).map(function (value, index) { return (jsxRuntime.jsx("div", { className: "setting-value", children: value }, "".concat(value, "-").concat(index))); })) }), isOpen && options && (jsxRuntime.jsx("div", { className: "setting-dropdown-menu", children: options.map(function (option) { return (jsxRuntime.jsxs("div", { className: "setting-dropdown-item", onClick: function () { return handleOptionClick(option); }, children: [mode === "single" ? (
                        // Radio button for single selection
                        jsxRuntime.jsx("div", { className: "setting-radio", children: values === option && (jsxRuntime.jsx("div", { className: "setting-radio-selected" })) })) : (
                        // Checkbox for multi selection
                        jsxRuntime.jsx("div", { className: "setting-checkbox", children: (Array.isArray(values) ? values : [values]).includes(option) && (jsxRuntime.jsx("svg", { className: "setting-checkbox-checked", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" }) })) })), jsxRuntime.jsx("span", { className: "".concat((mode === "single" && values === option) ||
                                (mode === "multi" &&
...
var SettingsOverview = function () {
    ...
    return (jsxRuntime.jsxs("div", { className: "settings-section", children: [jsxRuntime.jsxs("div", { className: "settings-header", children: [jsxRuntime.jsx("div", { className: "settings-title", children: "Overviews" }), jsxRuntime.jsx("button", { className: "settings-hide-button", children: "hide" })] }), jsxRuntime.jsxs("div", { className: "settings-content", children: [odi === null || odi === void 0 ? void 0 : odi.overviews.map(function (overview) {
                        var _a, _b, _c, _d, _e;
                        return (jsxRuntime.jsxs("div", { className: "settings-card", children: [jsxRuntime.jsx("button", { className: "settings-delete-button", onClick: function () { var _a; return removeOverview((_a = overview === null || overview === void 0 ? void 0 : overview.id) !== null && _a !== void 0 ? _a : ""); }, children: "Delete" }), jsxRuntime.jsxs("div", { className: "settings-row", children: [jsxRuntime.jsx(SettingComponent, { title: "Type", values: overview.type, options: Object.keys(overviewTypesMap), onChange: function (newValue) {
                                            ...
                                            } }), jsxRuntime.jsx(SettingComponent, { title: "Item View Type", values: (_b = (_a = overview.itemView) === null || _a === void 0 ? void 0 : _a.type) !== null && _b !== void 0 ? _b : "", options: Object.keys(itemViewTypesMap), onChange: function (newValue) {
                                                var updatedODI = __assign({}, odi);
                                                var overviewIndex = updatedODI.overviews.findIndex(function (o) { return o.id === overview.id; });
                                                if (overviewIndex !== -1) {
                                            ...
                                            } })] }), jsxRuntime.jsx(SettingComponent, { title: "Detail Views", values: (_d = (_c = overview.detailViews) === null || _c === void 0 ? void 0 : _c.map(function (dv) { return (typeof dv === "string" ? dv : dv.id); }).filter(function (id) { return !!id; })) !== null && _d !== void 0 ? _d : [], options: odi === null || odi === void 0 ? void 0 : odi.overviews.flatMap(function (overview) {
                                        var _a, _b;
                                    ...
                                    }, mode: "multi" }), jsxRuntime.jsx(SettingComponent, { title: "Attributes to Show", values: idsToRoles(getDataBindingById(odi, overview.bindingId).items, overview.shownAttributes === "all"
                                        ? ["all"]
                    ...
                    }), jsxRuntime.jsx("button", { className: "settings-add-button", onClick: function () { var _a; return addNewOverview((_a = customOverviews[0]) === null || _a === void 0 ? void 0 : _a.defaultSpec); }, children: "Add Overview" })] })] }));
};

var SettingsDetailView = function () {
    var _a;
    var _b = useODI(), odi = _b.odi, setODI = _b.setODI, addNewDetailView = _b.addNewDetailView;
    return (jsxRuntime.jsxs("div", { className: "settings-section", children: [jsxRuntime.jsxs("div", { className: "settings-header", children: [jsxRuntime.jsx("div", { className: "settings-title", children: "Detail Views" }), jsxRuntime.jsx("button", { className: "settings-hide-button", children: "hide" })] }), jsxRuntime.jsxs("div", { className: "settings-content", children: [(_a = odi === null || odi === void 0 ? void 0 : odi.overviews.flatMap(function (overview) { return overview.detailViews; }).filter(Boolean)) === null || _a === void 0 ? void 0 : _a.map(function (detailView) {
                        var _a, _b, _c, _d;
                        return (jsxRuntime.jsxs("div", { className: "settings-card", children: [jsxRuntime.jsx("button", { className: "settings-delete-button", children: "Delete" }), jsxRuntime.jsx("div", { className: "settings-row", children: jsxRuntime.jsx(SettingComponent, { title: "Type", values: detailView.type, options: Object.keys(detailViewTypesMap), onChange: function (value) {
                                            var _a;
                                            var updatedODI = __assign({}, odi);
                                        ...
                                        } }) }), jsxRuntime.jsxs("div", { className: "settings-row", children: [jsxRuntime.jsx(SettingComponent, { title: "Open in", values: (_a = detailView.openIn) !== null && _a !== void 0 ? _a : "", options: [
                                                "new-page",
                                                "side-by-side",
                                                "replace",
                                                "pop-up",
                                            ...
                                            } }), jsxRuntime.jsx(SettingComponent, { title: "Open by", values: (_b = detailView.openBy) !== null && _b !== void 0 ? _b : "", options: ["click", "hover"], onChange: function (value) {
                                                var _a;
                                                var updatedODI = __assign({}, odi);
                                                if (!updatedODI.overviews)
                                                    return;
                                            ...
                                            } })] }), jsxRuntime.jsx(SettingComponent, { title: "Open by selecting the following attributes", values: idsToRoles(getDataBindingById(odi, detailView.bindingId).items, (_c = detailView.openFrom) !== null && _c !== void 0 ? _c : []), options: __spreadArray(["item"], Object.keys(roleTypesMap), true), mode: "multi", onChange: function (value) {
                                        var _a;
                                        var updatedODI = __assign({}, odi);
                                        if (!updatedODI.overviews)
                                            return;
                                    ...
                                    } }), jsxRuntime.jsx(SettingComponent, { title: "Attributes to Show", values: idsToRoles(getDataBindingById(odi, detailView.bindingId).items, detailView.shownAttributes === "all"
                                        ? "all"
                    ...
                    }), jsxRuntime.jsx("button", { className: "settings-add-button", onClick: function () {
                            addNewDetailView();
...
var SettingsMalleability = function () {
    ...
    return (jsxRuntime.jsxs("div", { className: "settings-section", children: [jsxRuntime.jsxs("div", { className: "settings-header", children: [jsxRuntime.jsx("div", { className: "settings-title", children: "Malleability Features" }), jsxRuntime.jsx("button", { className: "settings-hide-button", children: "hide" })] }), jsxRuntime.jsxs("div", { className: "settings-card", children: [jsxRuntime.jsx("div", { className: "settings-toggle-container", children: jsxRuntime.jsx(SettingComponent, { title: "Toggle all malleability", values: ((_a = odi === null || odi === void 0 ? void 0 : odi.malleability) === null || _a === void 0 ? void 0 : _a.disabled) ? "disabled" : "enabled", toggleOptions: { on: "enabled", off: "disabled" }, onChange: function (value) {
                                var updatedODI = __assign({}, odi);
                                ...
                                setODI(updatedODI);
                            }, mode: "toggle" }) }), jsxRuntime.jsx("div", { className: "settings-dimensions ".concat(((_b = odi === null || odi === void 0 ? void 0 : odi.malleability) === null || _b === void 0 ? void 0 : _b.disabled) ? "disabled" : ""), children: ["content", "composition", "layout"].map(function (dimension) {
                            var _a, _b;
                            var malleabilityOption = (_a = odi === null || odi === void 0 ? void 0 : odi.malleability) === null || _a === void 0 ? void 0 : _a[dimension];
                            return (jsxRuntime.jsxs("div", { className: "settings-dimension", children: [jsxRuntime.jsx(SettingComponent, { title: dimension, values: (malleabilityOption === null || malleabilityOption === void 0 ? void 0 : malleabilityOption.disabled) ? "disabled" : "enabled", toggleOptions: { on: "enabled", off: "disabled" }, onChange: function (value) {
                                            var updatedODI = __assign({}, odi);
                                            ...
                                            setODI(updatedODI);
                                        }, mode: "toggle" }), jsxRuntime.jsx(SettingComponent, { title: "Feature Types", values: (_b = malleabilityOption === null || malleabilityOption === void 0 ? void 0 : malleabilityOption.types) !== null && _b !== void 0 ? _b : [], options: defaultMalleabilityDimension[dimension], mode: "multi", onChange: function (newValue) {
                                            var updatedODI = __assign({}, odi);
                                            if (!updatedODI.malleability)
                                                return;
...
var SettingsPanel = function () {
    return (jsxRuntime.jsxs("div", { className: "settings-panel", children: [jsxRuntime.jsx("div", { className: "settings-panel-header", children: jsxRuntime.jsxs("div", { className: "settings-panel-title", children: [jsxRuntime.jsx("div", { className: "settings-panel-name", children: "Meridian Settings" }), jsxRuntime.jsx("div", { className: "settings-panel-collapse", children: jsxRuntime.jsx("button", { className: "settings-close-button", onClick: function () {
                                    return useODI.getState().setMalleabilityConsoleOpen(false);
                                }, children: jsxRuntime.jsx("svg", { width: "8", height: "8", viewBox: "0 0 8 8", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: jsxRuntime.jsx("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M0.46967 6.46967C0.176777 6.76256 0.176777 7.23744 0.46967 7.53033C0.762563 7.82322 1.23744 7.82322 1.53033 7.53033L3.99902 5.06164L6.46967 7.53228C6.76256 7.82518 7.23744 7.82518 7.53033 7.53228C7.82322 7.23939 7.82322 6.76452 7.53033 6.47162L5.05968 4.00098L7.53033 1.53033C7.82322 1.23744 7.82322 0.762563 7.53033 0.46967C7.23744 0.176777 6.76256 0.176776 6.46967 0.46967L3.99902 2.94032L1.53033 0.471623C1.23744 0.17873 0.762563 0.17873 0.46967 0.471623C0.176777 0.764517 0.176777 1.23939 0.46967 1.53228L2.93836 4.00098L0.46967 6.46967Z", fill: "black" }) }) }) })] }) }), jsxRuntime.jsx("hr", { className: "settings-divider" }), jsxRuntime.jsxs("div", { className: "settings-panel-content", children: [jsxRuntime.jsx(SettingsOverview, {}), jsxRuntime.jsx(SettingsDetailView, {}), jsxRuntime.jsx(SettingsMalleability, {})] })] }));
};
...
var MeridianWrapper = function (_a) {
    ...
    if (!odi)
        return jsxRuntime.jsx(jsxRuntime.Fragment, {});
    return (jsxRuntime.jsxs("div", { className: "odi-wrapper-container", children: [
            // ---- MALLEABILITY CONSOLE ----
            malleabilityConsoleOpen && (jsxRuntime.jsxs("div", { className: "malleability-console", children: [jsxRuntime.jsx("div", { className: "console-overlay", onClick: function () { return setMalleabilityConsoleOpen(false); } }), jsxRuntime.jsx(SettingsPanel, {})] })), jsxRuntime.jsxs("div", { className: wrapperClassName, children: [
                    // ---- POPUP VIEW ----
                    odi && (selectedItemEntity === null || selectedItemEntity === void 0 ? void 0 : selectedItemEntity.detail.openIn) === "pop-up" && (jsxRuntime.jsxs("div", { className: "pop-up", children: [jsxRuntime.jsx("div", { className: "overlay", onClick: clearSelectedItemEntity }), jsxRuntime.jsx("div", { className: "detail-view-wrapper", children: jsxRuntime.jsx(MeridianDetail, { odi: odi, itemId: selectedItemEntity === null || selectedItemEntity === void 0 ? void 0 : selectedItemEntity.itemId }) })] })), 
                    // ---- MALLEABILITY TOOLTIPS ----
                    selectedAttributes.length > 0 && (jsxRuntime.jsxs("div", { className: "malleability-tooltip", style: {
                            left: lastSelected.position.x,
                            top: lastSelected.position.y,
                        }, children: [lastSelected.view === "overview" && (jsxRuntime.jsx("button", { onClick: function () {
                                    setSpecShownAttributes("hide");
                                    // Reset selection
                                    clearSelection();
                                    setHighlightAttributes(false);
                                }, children: "Hide Attributes" })), lastSelected.view === "detail" && (jsxRuntime.jsx("button", { onClick: function () {
...
var MalleabilityToolbar = function () {
    return (jsxRuntime.jsx("div", { className: "fixed w-full flex justify-center mx-auto bottom-[40px] z-40", children: jsxRuntime.jsx("div", { className: "px-8 py-4 rounded-2xl bg-white shadow-2xl border-2 border-gray-200", children: 
            // ---- COMPOSITION
            "test" }) }));
};

exports.Attribute = Attribute;
exports.AttributePrice = AttributePrice;
exports.DetailBasic = DetailBasic;
exports.ItemCompact = ItemCompact;
exports.ItemPin = ItemPin;
exports.ItemProfile = ItemProfile;
exports.ItemVertical = ItemVertical;
exports.MalleabilityAttributesToggle = MalleabilityAttributesToggle;
exports.MalleabilityOvervewTabs = MalleabilityOvervewTabs;
exports.MalleabilityToolbar = MalleabilityToolbar;
exports.MeridianDetail = MeridianDetail;
exports.MeridianItem = MeridianItem;
exports.MeridianOverview = MeridianOverview;
exports.MeridianWrapper = MeridianWrapper;
exports.SettingComponent = SettingComponent;
exports.SettingsDetailView = SettingsDetailView;
exports.SettingsMalleability = SettingsMalleability;
exports.SettingsOverview = SettingsOverview;
exports.SettingsPanel = SettingsPanel;
exports.addAttributeToScope = addAttributeToScope;
exports.addAttributeType = addAttributeType;
exports.addDetailViewType = addDetailViewType;
exports.addItemViewType = addItemViewType;
exports.addOverviewType = addOverviewType;
exports.attributeInScope = attributeInScope;
exports.attributeTypesMap = attributeTypesMap;
exports.checkDataLists = checkDataLists;
exports.convertFetchedODIToODI = convertFetchedODIToODI;
exports.defaultDetailView = defaultDetailView;
exports.defaultMalleability = defaultMalleability;
exports.defaultMalleabilityDimension = defaultMalleabilityDimension;
exports.defaultOverview = defaultOverview;
exports.denormalizeComposedOverview = denormalizeComposedOverview;
exports.denormalizeDetail = denormalizeDetail;
exports.denormalizeODI = denormalizeODI;
exports.denormalizeOverview = denormalizeOverview;
exports.detailViewTypesMap = detailViewTypesMap;
exports.emptyAttributeSet = emptyAttributeSet;
exports.filterAttributeFromScope = filterAttributeFromScope;
exports.filterItemAttributes = filterItemAttributes;
exports.findDetail = findDetail;
exports.findDetailViewById = findDetailViewById;
exports.findDetailViewToOpen = findDetailViewToOpen;
exports.findItemDetailViewToOpen = findItemDetailViewToOpen;
exports.findOverview = findOverview;
exports.findOverviewById = findOverviewById;
exports.findOverviewFromItsDetail = findOverviewFromItsDetail;
exports.getAttributeDataBindingById = getAttributeDataBindingById;
exports.getAttributeIdsByDepth = getAttributeIdsByDepth;
exports.getAttributeTypesMap = getAttributeTypesMap;
exports.getAttributesByHasRole = getAttributesByHasRole;
exports.getAttributesByRole = getAttributesByRole;
exports.getAttributesWithoutRoles = getAttributesWithoutRoles;
exports.getBottomCenter = getBottomCenter;
exports.getDataBindingById = getDataBindingById;
exports.getDetailViewById = getDetailViewById;
exports.getDetailViewTypesMap = getDetailViewTypesMap;
exports.getFetchedODIFromData = getFetchedODIFromData;
exports.getFirstDetail = getFirstDetail;
exports.getFirstOverview = getFirstOverview;
exports.getItemViewTypesMap = getItemViewTypesMap;
exports.getOverviewById = getOverviewById;
exports.getOverviewTypesMap = getOverviewTypesMap;
exports.getPartitionSize = getPartitionSize;
exports.getRecursiveAttributes = getRecursiveAttributes;
exports.getRoles = getRoles;
exports.idsToRoles = idsToRoles;
exports.isAttributeType = isAttributeType;
exports.isRole = isRole;
exports.itemViewTypesMap = itemViewTypesMap;
exports.makeDetails = makeDetails;
exports.mapDataToFetchedItems = mapDataToFetchedItems;
exports.mapRecursiveAttributes = mapRecursiveAttributes;
exports.overviewTypesMap = overviewTypesMap;
exports.removeDuplicates = removeDuplicates;
exports.resolveValue = resolveValue;
exports.roleTypesMap = roleTypesMap;
exports.rolesToIds = rolesToIds;
exports.toTitleCase = toTitleCase;
exports.useODI = useODI;
exports.uuid = uuid;
